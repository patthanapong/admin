      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="mailbox">
           ...
           <ul class="treeview-menu">
            <li><a href="composer"><i class="fa fa-circle-o"></i> composer</a></li>
            <li><a href="mailbox"><i class="fa fa-circle-o"></i> mailbox</a></li>
            <li><a href="real-mail"><i class="fa fa-circle-o"></i> real-mail</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
